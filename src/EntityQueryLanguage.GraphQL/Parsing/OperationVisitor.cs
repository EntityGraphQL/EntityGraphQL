...
{
    internal class OperationVisitor : EqlGrammerBaseVisitor<GraphQLOperation>
    {
        ...
        public override GraphQLOperation VisitOperationName(EqlGrammerParser.OperationNameContext context)
        {
        ...
        public override GraphQLOperation VisitGqlTypeDef(EqlGrammerParser.GqlTypeDefContext context)
        {
