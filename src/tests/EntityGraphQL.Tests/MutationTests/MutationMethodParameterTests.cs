...
public class MutationMethodParameterTests
{
    ...
    public void TestSeparateArguments_PrimitivesOnly()
    {
        ...
        {
            Query =
                @"mutation addPersonPrimitive($id: Int, $name: String!, $birthday: DateTime, $weight: decimal, $gender: Gender) {
    ...
    public void TestSeparateArguments_PrimitivesOnly_WithInlineDefaults()
    {
        ...
        {
            Query =
                @"mutation addPersonPrimitive($birthday: DateTime, $weight: decimal, $gender: Gender) {
    ...
    public void TestSeparateArguments()
    {
        ...
        {
            Query =
                @"mutation AddPersonSeparateArguments($name: String!, $names: [String!], $nameInput: InputObject, $gender: Gender) {
    ...
    public void TestSingleArgument()
    {
        ...
        {
            Query =
                @"mutation AddPersonSingleArgument($nameInput: InputObject) {
    ...
    public void TestSingleArgument_DifferentVariableName()
    {
        ...
        {
            Query =
                @"mutation AddPersonSingleArgument($differentName: InputObject) {
    ...
    public void TestSingleArgument_AutoAddInputTypes_NestedType()
    {
        ...
        {
            Query =
                @"mutation AddPersonSingleArgumentNestedType($nameInput: NestedInputObject) {
