...
public class DateAndTimeScalarsTests
{
    ...
    public void EntityQuery_WorksWithDateOnly(string dateValue)
    {
        ...
        var list = new List<WithDateOnly> { new(new DateOnly(2020, 08, 10), "First"), new(new DateOnly(2020, 08, 11), "Second"), new(new DateOnly(2020, 08, 12), "Third") };
    ...
    public void EntityQuery_WorksWithTimeOnly(string timeValue, int expectedCount)
    {
        ...
        var list = new List<WithTimeOnly> { new(new TimeOnly(13, 21, 11), "First"), new(new TimeOnly(13, 22, 11), "Second"), new(new TimeOnly(13, 23, 11), "Third") };
    ...
    public void EntityQuery_WorksWithTimeSpan(string spanValue, int expectedCount)
    {
        ...
        var list = new List<WithTimeSpan> { new(TimeSpan.FromHours(1), "First"), new(new TimeSpan(1, 2, 3), "Second"), new(new TimeSpan(3, 0, 0), "Third") };
    ...
    public void Mutation_Deserializes_DateOnly_TimeOnly_TimeSpan()
    {
        ...
        var req = new QueryRequest { Query = @"mutation m { echo(d: ""2020-08-11"", t: ""13:22:11"", span: ""01:02:03"") { d t span } }" };
