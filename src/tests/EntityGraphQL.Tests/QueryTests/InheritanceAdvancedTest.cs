...
""query"": ""query Order($orderId: Int) {
    ...
    [Fact]
    public void InheritanceTestUsingResolve()
    {
        var context = new TestContext()
        {
            Orders =
        ...
        schemaProvider.UpdateType<TShirtOrderItem>(Order =>
        {
            Order.AddField("statusAsString", "Get the order status as a string").Resolve<TestService>((o, srv) => srv.FormatTShirtPropertiesAsString(o.Colour, o.Size));
        });
    ...
    [Fact]
    public void InheritanceTestUsingResolveUsingArgs()
    {
        var context = new TestContext()
        {
            Orders =
        ...
        schemaProvider.UpdateType<TShirtOrderItem>(Order =>
        {
            Order
                ...
                .Resolve<TestService>((o, args, srv) => srv.FormatTShirtPropertiesAsString(o.Colour, o.Size, args.Length));
        });
