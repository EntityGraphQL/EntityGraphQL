...
public class AuthorizeDirective : ISchemaDirective
{
    ...
    public IEnumerable<TypeSystemDirectiveLocation> Location => new[] { TypeSystemDirectiveLocation.QueryObject, TypeSystemDirectiveLocation.FieldDefinition };
