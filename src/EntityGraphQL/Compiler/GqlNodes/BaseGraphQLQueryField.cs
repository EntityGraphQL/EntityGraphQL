...
namespace EntityGraphQL.Compiler
{
    ...
    public abstract class BaseGraphQLQueryField : BaseGraphQLField
    {
        ...
        /// </summary>
        protected ParameterExpression? DefaultHandleBulkResolverForField(CompileContext compileContext, BaseGraphQLField field, IBulkFieldResolver bulkResolver, ParameterExpression? docParam, object? docVariables, ParameterReplacer replacer)
        {
