...
public class ParameterReplacer : ExpressionVisitor
{
    ...
    /// <summary>
    /// Rebuilds the expression by replacing toReplace with newParam.
    /// Used when rebuilding expressions to happen from the sans-services results
    /// </summary>
    /// <param name="node">Expression to search through</param>
    /// <param name="toReplace">Expression to match for replacement</param>
