...
public class SchemaBuilderOptions
{
    ...
    /// <summary>
    /// List of Attribute types which will cause the builder to ignore the field/property when building the schema. These are additional to GraphQLIgnoreAttribute
    /// </summary>
