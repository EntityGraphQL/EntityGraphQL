...
public class MutationType
{
    ...
    public MutationType AddFrom<TType>(SchemaBuilderMethodOptions? options = null) where TType : class
    {
    ...
    /// <param name="options">Options for the schema builder</param>
    public MutationField Add(Delegate mutationDelegate, SchemaBuilderMethodOptions? options = null)
    {
    ...
    /// <param name="mutationDelegate">A method to execute the mutation logic</param>
    /// <param name="options">Options for the schema builder</param>
    public MutationField Add(string mutationName, Delegate mutationDelegate, SchemaBuilderMethodOptions? options = null)
    {
    ...
    /// <param name="mutationDelegate">A method to execute the mutation logic</param>
    /// <param name="options">Options for the schema builder</param>
    public MutationField Add(string mutationName, string description, Delegate mutationDelegate, SchemaBuilderMethodOptions? options = null)
    {
        return AddMutationMethod(mutationName, null, mutationDelegate.Method, description, options);
    }

    private MutationField AddMutationMethod(string name, RequiredAuthorization? classLevelRequiredAuth, MethodInfo method, string? description, SchemaBuilderMethodOptions? options)
    {
        options ??= new SchemaBuilderMethodOptions();
