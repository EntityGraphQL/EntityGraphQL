...
namespace EntityGraphQL.Schema.FieldExtensions
{
    public interface IFieldExtension
    {
        ...
        /// <returns></returns>
        Expression? GetExpression(IField field, Expression expression, ParameterExpression? argExpression, dynamic? arguments, Expression context, IGraphQLNode? parentNode, bool servicesPass, ParameterReplacer parameterReplacer);
        /// <summary>
