...
public abstract partial class BaseSchemaTypeWithFields<TFieldType> : ISchemaType
    where TFieldType : IField
{
    public ISchemaProvider Schema { get; }
    internal Dictionary<string, TFieldType> FieldsByName { get; } = [];
    ...
    public bool IsInput => GqlType == GqlTypes.InputObject;
    public bool IsInterface => GqlType == GqlTypes.Interface;
    public bool IsEnum => GqlType == GqlTypes.Enum;
    public bool IsScalar => GqlType == GqlTypes.Scalar;
