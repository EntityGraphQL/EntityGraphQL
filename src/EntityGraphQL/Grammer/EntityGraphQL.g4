...
fieldSelect     : '{' (ws* | comment*) (aliasExp | field | fragmentQuery | entityQuery | comment) ((ws* ','? ws*) (aliasExp | field | fragmentQuery | entityQuery | comment))* (ws* | comment*) '}';
...
comment         : ws* '#' ~( '\r' | '\n' )* ws*;
gqlFragment     : ws* 'fragment' ws+ fragmentName=identity ws+ 'on' ws+ fragmentType=identity ws* fieldSelect ws*;
fragmentQuery  : '...' name=identity;
