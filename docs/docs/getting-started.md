...
See the serialization tests for [an example with Newtonsoft.Json](https://github.com/EntityGraphQL/EntityGraphQL/blob/main/src/tests/EntityGraphQL.Tests/SerializationTests.cs).
